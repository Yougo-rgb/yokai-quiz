...
Open `index.html` with a **local server** (recommended: use the **Live Server** extension in VS Code), otherwise some features like images and PDF export may not work due to browser security restrictions.
...
This project is **not affiliated with Level-5**.
Yo-kai Watch and all related assets belong to their respective owners.
...
* Inspiration: [Pokémon Quiz](https://pkmnquiz.com/)